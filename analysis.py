...
def extract_sin(mod_X_m: np.ndarray, phase_X_m: np.ndarray, f_fund: float, f_e: float, w_list: np.ndarray) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
    """
...
def export_data(frequencies_lp: np.ndarray, mod_X_m_lp: np.ndarray, phase_X_m_lp: np.ndarray,
                frequencies_bs: np.ndarray, mod_X_m_bs: np.ndarray, phase_X_m_bs: np.ndarray) -> None:
    """
    Export frequency, module and phase from the selected harmonics to a csv file
    :param frequencies_lp: frequencies of the selected harmonics
    :param mod_X_m_lp: modules of the selected harmonics
    :param phase_X_m_lp: phases of the selected harmonics
    :param frequencies_bs: frequencies of the selected harmonics
    :param mod_X_m_bs: modules of the selected harmonics
    :param phase_X_m_bs: phases of the selected harmonics
    :return: None
    """
    df = pd.DataFrame({'Fréquences LA#': frequencies_lp, 'Modules LA#': mod_X_m_lp, 'Phases LA#': phase_X_m_lp,
                       'Fréquences basson': frequencies_bs, 'Modules basson': mod_X_m_bs, 'Phases basson': phase_X_m_bs})
